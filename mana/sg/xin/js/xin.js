...
function go_hymn_box(main)
{
  ...
  +'\u8f93\u5165\u9996\u6570 (1-167)&nbsp; <input type=text size=8 name=num>'
...
if(num<1||num>780){return alert("Number out of range (Valid: 1-167)")}
  window.location.href=(pre_dir?pre_dir:"")+"xin/"+"xin"+num+".htm"
}
