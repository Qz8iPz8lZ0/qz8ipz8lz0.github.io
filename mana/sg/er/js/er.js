...
function go_hymn_box(main)
{
  ...
  +'\u8f93\u5165\u9996\u6570 (1-1232)&nbsp; <input type=text size=8 name=num>'
...
if(num<1||num>1232){return alert("Number out of range (Valid: 1-1232)")}
  window.location.href=(pre_dir?pre_dir:"")+"er/"+"er"+num+".htm"
}
